...
ActiveRecord::Schema.define(version: 20_210_807_200_149) do
  ...
  create_table 'categories_questions', force: :cascade do |t|
    ...
    t.index %w[question_id category_id], name: 'index_categories_questions_on_question_id_and_category_id',
                                         unique: true
